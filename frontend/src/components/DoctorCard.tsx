...
export function DoctorCard({ doctor, onViewDoctor }: DoctorCardProps) {
  return (
    <div 
      className="relative group backdrop-blur-xl bg-gradient-to-br from-white/5 via-white/3 to-transparent rounded-3xl p-6 border border-white/10 shadow-2xl hover:shadow-purple-500/20 transition-all duration-500 hover:scale-[1.02] hover:border-purple-500/30 cursor-pointer animate-fade-in-up h-full flex flex-col"
    ...
    >
      ...
      <div className="relative z-10 flex flex-col h-full">
        ...
        <div className="flex justify-center mb-5">
          <div className="w-40 h-40 rounded-3xl overflow-hidden bg-gradient-to-br from-purple-500/20 to-purple-600/20 border-2 border-purple-400/50 hover:border-purple-300/70 transition-all duration-300 group shadow-lg shadow-purple-500/20">
            {doctor.imageUrl ? (
              <ImageWithFallback
                src={doctor.imageUrl}
                alt={doctor.name}
        ...
        <div className="flex-1 flex flex-col space-y-4">
          ...
          <div className="text-center">
            ...
            <p className="text-purple-300 font-medium">{doctor.specialization}</p>
          </div>
          ...
          <div className="mt-auto pt-4">
            <Button 
              className="w-full bg-gradient-to-r from-purple-600 via-purple-500 to-purple-600 hover:from-purple-500 hover:via-purple-400 hover:to-purple-500 text-white rounded-xl py-3 shadow-2xl shadow-purple-500/30 hover:shadow-purple-500/50 transition-all duration-300 hover:scale-105 transform font-semibold"
              onClick={(e) => {
                e.stopPropagation();
